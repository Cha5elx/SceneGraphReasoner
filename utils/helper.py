...
def scanrefer_get_unique_multiple_lookup(anno_dir='annotations'):
    unique_multiple_lookup_file = os.path.join(anno_dir, 'scanrefer_unique_multiple_lookup.json')
    if not os.path.exists(unique_multiple_lookup_file):
        ...
        raw2label = {}
        with open(os.path.join(anno_dir, 'scannet/scannetv2-labels.combined.tsv'), 'r') as f:
        ...
        scanrefer_data = json.load(open(os.path.join(anno_dir, 'scanrefer/ScanRefer_filtered.json')))
